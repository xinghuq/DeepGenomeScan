...
#### before run  the model, set parallel 
library(doParallel)
cl <- makePSOCKcluster(5)
registerDoParallel(cl)
### some cluster may not able to use the parallel when calling RSNNS Tensorflow
### 
Sys.time()
...
save.image(file = "MLP_final_mlpWeightDecayML_after_trained_data.RData")
